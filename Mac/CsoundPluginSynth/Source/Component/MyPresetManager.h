...
public:
    ...
    MyPresetManager(NewProjectAudioProcessor& p): processor(p)
    {
        ...
        { 
            ...
            juce::String path = userDocument.getFullPathName()+ "/CsoundPluginSynth";
...
private:
    juce::WildcardFileFilter presetFilter {"*.csd;", "*", "CsoundPluginSynth"};
    juce::TimeSliceThread directoryThread {"CsoundPluginSynth File Scanner Thread"};
